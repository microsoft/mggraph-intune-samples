...
Function Get-ConfigurationPolicySettings() {
    ...
    <#
.SYNOPSIS
This function is used to get Configuration policy Settings from the Graph API REST interface
.DESCRIPTION
The function connects to the Graph API Interface and gets any Configuration policy Settings
.EXAMPLE
Get-ConfigurationPolicySettings -policyid policyid
Returns any Configuration policy Settings configured in Intune
.NOTES
NAME: Get-ConfigurationPolicySettings
#>
...
if ($Policies) {
    ...
    foreach ($policy in $Policies) {
        ...
        $SettingInstances = Get-ConfigurationPolicySettings -policyid $policyid
    ...
    Write-Host "No Configuration policies found..." -ForegroundColor Red
    Write-Host
